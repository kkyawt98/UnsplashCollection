...
class CategoryViewHolder(var v:View,
private val mClickListener:subClickListener) : RecyclerView.ViewHolder(v) {
    ...
    fun bind(collection: CollectionItem){
        ...
        v.rootView.setOnClickListener {
            mClickListener.onItemClick(collection)
        }
    }

    interface subClickListener{
        fun onItemClick(category: CollectionItem)
    }
}