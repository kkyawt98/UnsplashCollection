...
class CollectionsAdapter (var collectionsList: List<UsersCollectionsItem> = emptyList()) : RecyclerView.Adapter<CollectionsViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CollectionsViewHolder {
        return CollectionsViewHolder(parent.context.bindView(R.layout.item_collection, parent))
    }
